        ...
        <Card.Body>
          <div className="row g-3">
            ...
            <div className="col-md-2">
              <Form.Group>
                <Form.Label>{t('readingList.status.unread')}</Form.Label>
                <Form.Select
            ...
            <div className="col-md-2">
              <Form.Group>
                <Form.Label>{t('readingList.filters.priority')}</Form.Label>
                <Form.Select
            ...
            <div className="col-md-2">
              <Form.Group>
                <Form.Label>{t('readingList.filters.sortBy')}</Form.Label>
                <Form.Select
            ...
            <div className="col-md-2">
              <Form.Group>
                ...
                >
                  <option value="desc">{t('paperSearch.sortByDate')}</option>
      ...
      {filteredItems.length === 0 ? (
          ...
          <Card.Body className="text-center py-5">
            {items.length === 0 ? (
              ...
              <>
                ...
                <h3 className="mt-3">No papers match your filters</h3>
        ...
        <>
          ...
          <div className="mb-3">
            <Form.Check
              type="checkbox"
              label={`Select all ${paginatedItems.length} items on this page`}
          ...
          <div className="text-center text-muted mt-3">
            <small>
              Showing {(currentPage - 1) * itemsPerPage + 1}-{Math.min(currentPage * itemsPerPage, filteredItems.length)} of {filteredItems.length} papers
            </small>
          </div>
        </>
      )}
